...
FCKConfig.ToolbarSets["Custom"] = [
  ['Source','-','Preview'],
	...
	['Rule','SpecialChar'],
	['About'],
	['Style','FontName','FontSize','TextColor'],
...
FCKConfig.ToolbarSets["MsgBoard"] = [
  ['Templates'],
        ['Cut','Copy','Paste','PasteWord','-','SpellCheck'],
        ['Undo','Redo','RemoveFormat'],
        ['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
        ['Link','Unlink','Smiley','Image','Table','Rule','SpecialChar'],
        ['About'],
        '/',
        ['Style','FontName','TextColor'],
